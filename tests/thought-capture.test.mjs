...
const captureSource = await readFile(new URL("../src/thought-capture.js", import.meta.url), "utf8");
...
test("bridge refinement submits human-authored meaning and one secondary anchor", () => {
  assert.match(captureSource, /secondaryMediaId: this\.bridgeMode \? this\.selectedSecondaryMediaId : null/);
...
test("later private text editing keeps both bridge works visible and the shared-meaning prompt", () => {
  ...
  assert.match(captureSource, /this\.bridgeMode \|\| this\.hasBridge/);
});
